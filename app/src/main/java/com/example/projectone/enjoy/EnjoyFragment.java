...
//        enjoy1.save();
        ...
        enjoy1.setType(0);
        enjoy1.setLikes(0);
        enjoy1.setDate("2024年04月07日 17:05:55");
        enjoy1.setTitle("零基础游泳教学：必看五大游泳入门教程");
        enjoy1.setText("游泳是众所周知的一项运动，但是对这一名词的具体解释了解甚少。游泳主要是通过利用水和身体相互协调的作用在水中进行的一项体育运动，该运动既能够增强自身的体质，还能作为一种娱乐休闲活动。那么初学者该怎么做才能快速掌握游泳的方法技巧呢？下面为大家带来零基础游泳教学：必看五大游泳入门教程，让您轻轻松松水上漂。\n" +
                "\n");
        enjoy1.setUrl("https://zhuanlan.zhihu.com/p/114469455");
        enjoy1.save();
    }
}
